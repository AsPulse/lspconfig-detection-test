...
--- @return TsProject?
local function detect_ts_project(source)
  ...
  --- @type Package?
  local closest_package = (#packages == 1 or (#packages > 1 and #packages[1].path > #packages[2].path))
    and packages[1]
    or nil
  ...
  --- @type Workspace?
  local detected_workspace = (#workspaces == 1 or (#workspaces > 1 and #workspaces[1].root_dir > #workspaces[2].root_dir))
    and workspaces[1]
    or nil
